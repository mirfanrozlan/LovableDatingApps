...
class FriendsMatchView extends StatelessWidget {
  FriendsMatchView({super.key});
  final _controller = FriendsController();

  @override
  Widget build(BuildContext context) {
    final items = _controller.matches();
    return AppScaffold(
          ...
          return Material(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 12),
                ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: AppTheme.primary), child: const Text('Connect')),
              ]),
            ),
          );
        },
